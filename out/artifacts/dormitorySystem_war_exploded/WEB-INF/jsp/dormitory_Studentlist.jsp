...
<%--    &lt;%&ndash;<meta http-equiv="Cache-Control" content="no-siteapp" />&ndash;%&gt;--%>
...
<%--        <tr>--%>
<%--            &lt;%&ndash;<th>&ndash;%&gt;--%>
<%--                &lt;%&ndash;<div class="layui-unselect header layui-form-checkbox" lay-skin="primary"><i class="layui-icon">&#xe605;</i></div>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</th>&ndash;%&gt;--%>
<%--            <th>宿舍编号</th>--%>
<%--            <th>宿舍楼</th>--%>
<%--            <th>已用床位</th>--%>
